...
function initTerminal() {
  ...
  const cmds = {
    ...
    certs: `Verified Credentials:<br>— Level 5 HDSE Diploma & Academic Transcript (Skills & Education Group Awards UK)<br>— Level 4 PDSE Diploma & Academic Transcript (Skills & Education Group Awards UK)<br>— Business Analyst Professional Diploma (Academy Europe)<br>— Introduction to MERN Stack (Simplilearn)<br>— ACE Multicloud Network Associate (Aviatrix)<br>— Oracle Cloud Infrastructure (OCI) Foundations & AI Foundations<br>— MongoDB for SQL Experts · BCU Student Card · Official Academic Letter · ISIC Global Card`,
